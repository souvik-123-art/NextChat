              ...
              <div className="flex justify-center items-center space-x-3">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-12 rounded-lg text-center text-xl font-bold border-2 border-gray-600 bg-gray-700 text-white focus:border-blue-600 outline-none"
                  />
                ))}
              </div>
            </div>
